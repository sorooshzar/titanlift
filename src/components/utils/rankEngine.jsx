export const RANKS = [
  ...
  { name: "platinum", label: "Platinum", color: "#E5E4E2", textColor: "#222", description: "Elite performance. You're in the top tier of dedicated gym-goers." },
  ...
  { name: "champion", label: "Champion", color: "#FF4500", textColor: "#fff", description: "Local legend territory. This muscle has been trained to a near-professional standard." },
  { name: "titan",    label: "Titan",    color: "#9400D3", textColor: "#fff", description: "Mastery of the muscle. You're approaching the ceiling of natural human performance." },
  { name: "olympian", label: "Olympian", color: "#7DF9FF", textColor: "#222", description: "Human limit. Professional / world-class level. An extraordinary achievement." },
];
