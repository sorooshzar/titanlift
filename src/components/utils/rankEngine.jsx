export const RANKS = [
  { name: "wood",     label: "Wood",     color: "#6B4423", textColor: "#fff", description: "Just getting started. Every rep counts — your foundation is being laid." },
  { name: "bronze",   label: "Bronze",   color: "#B87333", textColor: "#fff", description: "Novice lifter. You're building the neuromuscular patterns that lead to real strength." },
  { name: "silver",   label: "Silver",   color: "#708090", textColor: "#fff", description: "Intermediate. Consistent training is paying off — this muscle is responding to load." },
  ...
  { name: "platinum", label: "Platinum", color: "#F0F8FF", textColor: "#000", description: "Elite performance. You're in the top tier of dedicated gym-goers." },
  ...
  { name: "champion", label: "Champion", color: "#22C55E", textColor: "#fff", description: "Local legend territory. This muscle has been trained to a near-professional standard." },
  { name: "titan",    label: "Titan",    color: "#1E3A8A", textColor: "#fff", description: "Mastery of the muscle. You're approaching the ceiling of natural human performance." },
  { name: "olympian", label: "Olympian", color: "#0EA5E9", textColor: "#fff", description: "Human limit. Professional / world-class level. An extraordinary achievement." },
];
